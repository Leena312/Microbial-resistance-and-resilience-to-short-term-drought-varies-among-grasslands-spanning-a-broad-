...
pdf(file="Shannon Diversity chapter 4 16S recovery1",
    width=10,
    height=8)
a<-boxplot(ControlSGSshan, DroughtSGSshan, ControlCHYshan, DroughtCHYshan, ControlHYSshan, DroughtHYSshan, ControlKNZshan, DroughtKNZshan, col=colors, main = "Treatment", ylab = "Shannon's Diversity", xlab = "Treament", 
...
pdf(file="Richness chapter 4 16S all",
    width=10,
    height=8)
...
pdf(file="GHPBETAKNZ16SRecovery",
    width=8,
    height=8)
...
write.csv(zotu_NBGLM_tax_ITS, "zotu_NBGLM_phylum_16S_KNZ_recovery1.csv")
